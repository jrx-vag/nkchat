...
-export([start/0, start/2, stop/1, register_types/0]).
...
register_types() ->
    nkdomain_reg:register_modules([
           nkchat_conversation_obj, nkchat_message_obj, nkchat_session_obj,
           nkchat_media_call_obj, nkchat_media_session_obj]).
