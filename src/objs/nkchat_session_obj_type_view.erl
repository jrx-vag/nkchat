    ...
    Spec = #{
        ...
        columns => [
            ...
            #{
                ...
                sort => true,
                options => nkdomain_admin_util:get_agg(<<"domain_id">>, ?CHAT_SESSION, Session)
            },
            #{
                id => service,
                type => text,
                ...
                sort => true,
                options => nkdomain_admin_util:get_agg(<<"srv_id">>, ?CHAT_SESSION, Session)
            },
            #{
                id => obj_name,
                type => text,
            ...
            #{
                ...
                sort => true,
                options => nkdomain_admin_util:get_agg(<<"created_by">>, ?CHAT_SESSION, Session),
                is_html => true % Will allow us to return HTML inside the column data
            },
            #{
                id => created_time,
